            ...
            <div>
                <div id="Mapa" className="seccion">
                    ...
                    <div id="Provincias" style={{position: 'absolute',margin: '0% -14%'}}>  
                        ...
                        <div id="Tucuman" className="ar-pcia ar-tucuman" title="Tucumán" onClick={() => this.funcion2("TUCUMÁN")}><span></span></div>
                        ...
                        <div id="Cordoba" className="ar-pcia ar-cordoba" title="Córdoba" onClick={() => this.funcion2("CÓRDOBA")}><span></span></div>
                        <div id="StaFe" className="ar-pcia ar-santa-fe" title="Sta. Fe" onClick={() => this.funcion2("SANTA FÉ")}><span></span></div>
                        ...
                        <div id="Neuquen" className="ar-pcia ar-neuquen" title="Neuquén" onClick={() => this.funcion2("NEUQUÉN")}><span></span></div>
